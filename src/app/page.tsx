...
export default function Home() {
  ...
  return (
    <main ref={heroRef} className="relative min-h-dvh bg-lsr-charcoal text-white grid place-items-center px-6 md:px-8 overflow-x-clip">
      ...
      >
        ...
        {/* subtle tech pattern */}
        <div className="absolute inset-0 opacity-[0.03] mix-blend-overlay [background-image:repeating-linear-gradient(135deg,white_0px,white_1px,transparent_1px,transparent_11px)]" />
      </motion.div>
      ...
      >
        ...
        <div className="mb-6">
          <div className="mx-auto w-fit inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[10px] md:text-xs uppercase tracking-wider text-white/70">
        ...
        <div className="relative block w-fit mx-auto isolate">
          {/* Base orange text */}
          <h1 className="relative z-10 font-display text-lsr-orange text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-wide drop-shadow-[0_6px_24px_rgba(191,87,0,0.45)] font-bold">
            LONGHORN&nbsp;SIM&nbsp;RACING
          </h1>
        ...
        {/* credibility chips */}
        <ul className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs md:text-sm text-white/70">
      ...
      <div className="group absolute bottom-0 inset-x-0 -mx-6 md:-mx-8 overflow-hidden border-t border-white/10 bg-black/20 backdrop-blur-sm z-20">        {/* edge fades */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-lsr-charcoal to-transparent z-20" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-lsr-charcoal to-transparent z-20" />

        {/* track (two copies for seamless loop) */}
        <div className="flex w-[200%] will-change-transform animate-[lsr-ticker_28s_linear_infinite] group-hover:[animation-play-state:paused] motion-reduce:animate-none">
          {/* 1st copy */}
